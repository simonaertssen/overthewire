...
def read_bandit_page(levelnum):
    ...
    if levelnum > 0:
        f.write(f'<div style="text-align: left"><a href="bandit/tasks/bandit{levelnum - 1}.md">Level {levelnum - 1}</a></div>\n')
    f.write(f'<div style="text-align: right"><a href="bandit/tasks/bandit{levelnum + 1}.md">Level {levelnum + 1}</a></div>\n')
